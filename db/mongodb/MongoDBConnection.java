...
public class MongoDBConnection implements DBConnection {
	...
	public String getFullname(String userId) {
		...
		FindIterable<Document> iterable = db.getCollection("users").find(eq("user_id", userId));
		if (iterable.first() != null) {
			name += iterable.first().containsKey("first_name") ? ((String) iterable.first().get("first_name") + " " ) : "";
			name += iterable.first().containsKey("last_name") ? (String) iterable.first().get("last_name") : "";
		}
		return name;
	}
	...
	public boolean verifyLogin(String userId, String password) {
		...
		if (iterable.first() != null && iterable.first().containsKey("password")) {
			return password.equals(iterable.first().get("password"));
		}
		return false;
	}
